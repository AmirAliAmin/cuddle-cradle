...
export default function PlaceOrder() {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t mx-5'>
      {/* left side */}
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            <div className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              ...
              <p className='text-red-500 text-sm font-medium mx-4 '>JAZZCASH</p>
            </div>
            <div className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p onClick={()=>setMethod("razorpay")} className={`min-w-3.5 h-3.5 border rounded-full ${method === 'razorpay'?"bg-green-400":""}`}></p>
              {/* <img className='h-5 mx-4' src={assets.razorpay_logo} alt="" /> */}
              <p className='text-purple-500 text-sm font-medium mx-4 '>RAZORPAY</p>
            </div>
            <div className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
